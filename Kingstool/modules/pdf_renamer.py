...
APP_INFO = {
    ...
    "description": "Extrai nomes de favorecidos/beneficiários de comprovantes PDF e renomeia os arquivos automaticamente.",
    "icon": ""
}
...
class AppView(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self.label_desc = ctk.CTkLabel(
            self, text="Selecione uma pasta contendo comprovantes em PDF para renomeá-los automaticamente.", 
        ...
        self.progress_bar = ctk.CTkProgressBar(self, height=12, corner_radius=6, fg_color="#0C0C0C", progress_color="#242424")
        self.progress_bar.set(0)
        self.progress_bar.pack(fill="x", pady=(0, 15))

        self.log_box = ctk.CTkTextbox(
            self, font=("Segoe UI", 12), height=250, fg_color="#0C0C0C", 
    ...
    def process_pdfs(self):
        ...
        if self.total_files == 0:
            self.append_log("[AVISO] Nenhum arquivo PDF encontrado na pasta selecionada.")
            return
        ...
        for filename in pdf_files:
            ...
            try:
                ...
                if not match:
                    ...
                    restored_path = os.path.join(folder_path, filename)
