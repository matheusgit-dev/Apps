...
class AppView(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self.color_frame = ctk.CTkFrame(self, fg_color="#0C0C0C", corner_radius=8)
        ...
        self.color_title.pack(anchor="w", padx=(25, 0))
        ...
        self.color_desc.pack(anchor="w", padx=(25, 0))

        self.color_btns = ctk.CTkFrame(self.color_frame, fg_color="transparent")
        self.color_btns.pack(side="right", padx=(0, 25))
