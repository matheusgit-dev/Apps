...
APP_INFO = {
    ...
    "description": "Transforma várias linhas de texto em uma única sequência separada por vírgulas.",
    "icon": ""
}
...
class AppView(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self.resultado = ctk.CTkTextbox(
            self, font=("Segoe UI", 13), height=150, fg_color="#0A0A0A", 
            text_color="#C0C0C0", border_color="#0A0A0A", corner_radius=5
        )
